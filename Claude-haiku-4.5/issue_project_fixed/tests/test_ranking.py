...
These test cases verify the correct ranking calculation implementation
"""
...
class TestRankingSystem:
    ...
    def test_two_students_tied_first_place(self):
        ...
        Expected: Rank 1, Rank 1, Rank 3
        Actual (buggy): Rank 1, Rank 2, Rank 3 (Wrong!)
        """
        ...
        # Charlie should be rank 3 (2 people ahead, so 2+1=3)
        assert rankings[2]["rank"] == 3, f"Charlie should be rank 3, actual is rank {rankings[2]['rank']}"
